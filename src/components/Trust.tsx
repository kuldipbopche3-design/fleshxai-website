...
export default function Trust() {
  return (
    <section id="trust" className="py-24 md:py-32 px-6 relative bg-[#ff6a37] overflow-hidden">
      ...
      />
      {/* PERFORMANCE FIX: Removed backdrop-blur-[20px] — GPU-intensive filter replaced with lightweight solid overlay */}
      <div className="absolute inset-0 bg-black/[0.12] pointer-events-none z-0"></div>
